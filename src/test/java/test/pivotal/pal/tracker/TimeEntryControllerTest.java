...
public class TimeEntryControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        MeterRegistry meterRegistry = mock(MeterRegistry.class);    doReturn(mock(DistributionSummary.class))
                .when(meterRegistry)
                .summary("timeEntry.summary");    doReturn(mock(Counter.class))
                .when(meterRegistry)
                .counter("timeEntry.actionCounter");    controller = new TimeEntryController(timeEntryRepository, meterRegistry);
    }
